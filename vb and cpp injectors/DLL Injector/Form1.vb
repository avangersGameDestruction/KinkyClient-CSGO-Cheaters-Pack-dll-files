...
1:      Me.Show()
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Timer1.Interval = 50
        Timer1.Start()
        MessageBox.Show("This Dll Injector is created by avangers", "Creator avangers")
        MessageBox.Show("Free to use Undetected Dll injector for everygame that is made and hacked where you need dll injection for", "Message")
        MessageBox.Show("Thanks for everyone who promote my injector by using him in there videos this is version 1 if the other versions are done i let you all know it and the other users gonna do it to ( i hope so )", "anouncement")
    End Sub
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        Process.Start("https://www.youtube.com/channel/UCRmuj7qE5J6qVVv8B5sVKWQ")
    End Sub
End Class